...
> gradle dependency (`project(':hardware-lib')` / `hardware-lib-7.8.0.aar`) and that MQTT
...
If consuming raw AARs instead: add `hardware-lib-7.8.0.aar`, `mqtt-lib-2.0.0.aar`, **and**
